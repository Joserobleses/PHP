 ...
 */
final class Version20211206165636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE place ADD user_id INT DEFAULT NULL, ADD is_verified TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE place DROP user_id, DROP is_verified');
    }
}

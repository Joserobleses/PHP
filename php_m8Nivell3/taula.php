...
<div class="container mt-4">
    <div class="row">
		...
		<div class="col text-end">
            <a href="insereix.php" role="button" class="btn btn-primary">Nou Producte</a>
        </div>
    </div>
    <div class="row">
        <table class="table table-hover table-striped">
            ...
            <?php  $sumatori=0; while ($fila = $descriptor->extreure_registre()) { $sumatori+=($fila["quantitat"]*$fila["preu"]); ?>
                <tr>
                    <th scope="row"><?php $fila["id"] ?><?php echo $fila["nom"] ?></th>
					...
					-->
                        ...
                        <a href="modificar.php?id=<?php echo $fila['id']?>" role="button" class="btn btn-sm btn-outline-secondary">
                            <i class="bi bi-pencil"></i>
                        </a>
						<a href="eliminar.php?id=<?php echo $fila['id']?>" role="button" class="btn btn-sm btn-outline-danger">

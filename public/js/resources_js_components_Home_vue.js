  ...
  return _c("div", { staticClass: "container" }, [
    _c(
      "div",
      {
        ...
        staticStyle: {
          "background-image":
            "url('https://cdn.pixabay.com/photo/2012/02/28/10/23/dice-18208_960_720.jpg')",
      ...
      [
        _c("h1", { staticClass: "border border-light rounded p-sm-2" }, [
          _vm._v('Benvinguts a "DADOS LOCOS" PHP_M15')
        ]),
        _vm._v(" "),
        _c("router-link", { attrs: { to: { name: "login" } } }, [
          _c("img", {
            attrs: {
              src:
                "https://pngimage.net/wp-content/uploads/2018/05/boton-jugar-png.png",
              alt: "boto jugar"
            }
          })
        ])

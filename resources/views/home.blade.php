    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6">
                    <h1>PHP_M12 League</h1>
                        <a href="{{route('equip.index')}}" role="button" class="btn btn-primary">Entra a l'aplicatiu</a>
        </div>    
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Football_%28soccer_ball%29.svg/450px-Football_%28soccer_ball%29.svg.png" width="300px" />
                </div>
            </div>
        </div>
    </body>

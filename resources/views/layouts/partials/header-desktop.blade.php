                    ...
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            <div class="header-wrap">
                                ...
                                <x-nav-link :href="route('reservas.create')" :active="request()->routeIs('equip.index')">
                                    {{ __('Crear Reserves') }}
                                </x-nav-link>
                                @endcan
                                <x-nav-link :href="route('reservas.index')" :active="request()->routeIs('equip.index')">
                                    {{ __('Llistat de reserves') }}
                                </x-nav-link>
                                </div>
